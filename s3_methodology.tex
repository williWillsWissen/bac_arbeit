...
Bevor auf die eigentliche Umsetzung eingegangen wird werden \Rd{noch kurz} die verwendeten Frameworks und Technologien \Rd{erklärt}\R{dargestellt}.
Ein Teil davon\R{,} wie HTTP und \Rd{Rest}\R{REST,} wurden bereits durch das Interface für KRESHMOI festgelegt, ein weiter ergab sich durch die Anforderung einer Web-Applikation.
Die Frameworks und Technologien für Grafik und GUI wurden gewählt weil mit Ihnen\Rc{klein...}  eine schnelle Umsetzung der Anforderungen möglich war.
...
Der Datenaustausch zwischen zwei Kommunikationspartner\R{n} findet in der From\R{Form} von Nachrichten statt, 
