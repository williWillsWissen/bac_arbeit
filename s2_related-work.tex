...
Von der Navigationsstruktur unterteilt sich OsiriX in eine Datenbankebene (Siehe Figure \ref{fig:osirix_db_view}) und eine Betrachtungsebene welche jeweils durch verschiedene Fenster umgesetzt wurden.
...
Die Funktionen zur Interaktion mit den Bilddaten sind bei den beiden erwähnten Software-Produkten sehr ähnlich \C{und von der Bedienung bis auf kleine Unterschide gleich umgesetzt.
...
\Rc{bei annähernd und grössere wird sich robert melden - versuchs ohne zu formulieren, konkreter zu machen.}
