...
Da sich die verschiedenen Resourcen qualitativ sehr stark voneinander unterscheiden können wird ein Bewertung ihrer Glaubwürdigkeit durchgeführt und dem Benutzer angezeigt. \Rc{ich würd da gleich einen screenshot des offiziellen GUIs zeigen und durcherklären und sagen dass dazu java nötig ist? und dann nochmal betonen dass es hier um die umsetzung davon mit webtechnologien geht?} 
\Cc{Soll ichs in diesem Kapitel machen oder eher ins related work rein geben?}
%%
