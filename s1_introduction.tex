...
Paralell zu dieser \Rc{welcher dieser, nicht klar }Applikation wurde im Rahmen des K\R{H}RESMOI-Projektes auch einen auf Java basierendes Interface System entwickelt,
welches eine Schnittstelle zum vollständigen Funktionsumfang von KRESHMOI \Rd{ist}\R{bietet}.
...
zu schwache Sicherheitseinstellungen und durch Täuschung der Benutzer mit Testzertifikaten \cite{java_risks_cisico} \cite{java_risks_bmi}.\Rc{2 cites hinterneinander immer in backslach klammer cite1 cite1 klammer} 
