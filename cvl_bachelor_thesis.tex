...
\abstract{
Diese Arbeit behandelt die Entwicklung einer Benutzeroberfl"ache f"ur eine Bildsuchmaschiene zum Durchsuchen von Bildern aus radiologischen bildgebenden Verfahren f"ur 2D und 3D als Web-Applikation.
Die Benutzeroberfl"ache dient als Frontend f"ur die Radiologie-Suche des KRESHMOI-Systems.
...
Weiters wird erkl"art wie die Software mit dem HTML5 Frameworks Cappuccino und Pixi.JS umgesetzt wurde und es werden zwei Ans"atze zur lokalen Nachbearbeitung der Bilder mit der Canvas 2D API und mit WebGL beschrieben und im Bezug auf ihre Performance getestet.

Von den beiden Verfahren f"uhrte nur das rendering mit WebGL zu einem ausreichend schnellen Ergebniss, welches auch im entwickelten Betrachter implementiert wurde.
}
\clearpage
