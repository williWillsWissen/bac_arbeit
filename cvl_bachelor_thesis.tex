...
\lstdefinelanguage{JavaScript}{
  ...
  ndkeywordstyle=\color{darkgray}\footnotesize,
  identifierstyle=\color{black},
  comment=[l]{//},
  morecomment=[s]{/*}{*/},
  commentstyle=\color{purple}\footnotesize,
...
\abstract{
Diese Arbeit behandelt die Entwicklung einer Web-Benutzeroberfl"ache f"ur eine Bildsuchmaschiene zum Durchsuchen von 3D-Daten aus radiologischen bildgebenden Verfahren.
...
Weiters wird erkl"art wie die Software mit dem HTML5 Frameworks Cappuccino und Pixi.JS umgesetzt wurde und es werden zwei Ans"atze zur lokalen Nachbearbeitung der Bilder mit der Canvas 2D API und mit WebGL beschrieben und im Bezug auf ihre Performance untersucht.
